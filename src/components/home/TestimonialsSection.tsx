      ...
      <div className="container relative z-10 px-4 md:px-6">
        ...
        <AnimatedSection delay={0.3} className="mt-10 flex justify-center">
          <div className="inline-flex items-center gap-3 bg-sand border border-border rounded-full px-5 py-2.5 shadow-sm">
             ...
             <span className="font-semibold text-charcoal text-sm">5.0 Average Rating</span>
             <span className="text-mountain-slate">•</span>
             <span className="text-mountain-slate text-sm">Google Reviews</span>
           </div>
        </AnimatedSection>
